...
function ProductList({ onHomeClick }) {
    ...
    // Derive addedToCart directly from Redux store so deleting an item re-enables the button
    const addedToCart = cartItems.reduce((acc, item) => ({ ...acc, [item.name]: true }), {});
            ...
            <div style={styleObjUl}>
                ...
                <div>
                    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className="cart">
                            {cartIcon}
                            <span className="cart_quantity_count">{totalCartQuantity > 0 ? totalCartQuantity : ''}</span>
                        </h1>
                    </a>
                </div>
            </div>
    ...
    return (
        <div>
            {!showCart ? (
                        ...
                        <div key={category.category}>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, index) => (
                                    <div className="product-card" key={`${category.category}-${plant.name}-${index}`}>
                ...
                <CartItem onContinueShopping={handleContinueShopping} onHomeClick={onHomeClick} navbar={navbar} />
            )}
        </div>
    );
}
